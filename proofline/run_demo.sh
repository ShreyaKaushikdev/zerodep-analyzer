...
python3 run.py analyze --before demo_repo/baseline --after demo_repo/patch --html report.html

echo ""
echo "2. Scaffolding Tests for unverified changes..."
python3 run.py scaffold-tests --before demo_repo/baseline --after demo_repo/patch
